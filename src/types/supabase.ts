  ...
  public: {
    Tables: {
      ...
      batch_relocations: {
        ...
        Relationships: [
          {
            foreignKeyName: "batch_relocations_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "batch_relocations_from_lot_id_fkey"
            columns: ["from_lot_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "batch_relocations_to_lot_id_fkey"
            columns: ["to_lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
      ...
      bookings: {
        Row: {
          ...
          cancel_by_driver_name: string | null
          code_booking: string | null
          created_at: string | null
      ...
      daily_summary: {
        Row: {
          ...
          total_diambil: number | null
          total_dipindah: number | null
        }
        Insert: {
          created_at?: string | null
          id?: string
      ...
      inbound_receipt_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "inbound_receipt_items_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "inbound_receipt_items_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inbound_receipt_items_receipt_id_fkey"
            columns: ["receipt_id"]
            isOneToOne: false
      ...
      inbound_receipts: {
        ...
        Relationships: [
          {
            foreignKeyName: "inbound_receipts_ceisa_doc_id_fkey"
            columns: ["ceisa_doc_id"]
            isOneToOne: false
            referencedRelation: "customs_docs"
            referencedColumns: ["id"]
          },
          {
      ...
      item_batches: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "item_batches_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
      ...
      item_locations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "item_locations_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
      ...
      outbound_manifests: {
        ...
        Relationships: [
          {
            foreignKeyName: "outbound_manifests_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "outbound_manifests_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
      ...
      picking_order_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "picking_order_items_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: false
            referencedRelation: "item_batches"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "picking_order_items_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
            referencedRelation: "items"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "picking_order_items_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "picking_order_items_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "picking_orders"
            referencedColumns: ["id"]
      ...
      picking_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "picking_orders_ceisa_doc_id_fkey"
            columns: ["ceisa_doc_id"]
            isOneToOne: false
            referencedRelation: "customs_docs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "picking_orders_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["id"]
      ...
      stock_movements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "stock_movements_ceisa_doc_id_fkey"
            columns: ["ceisa_doc_id"]
            isOneToOne: false
            referencedRelation: "customs_docs"
            referencedColumns: ["id"]
      ...
      storage_costs: {
        ...
        Relationships: [
          {
            foreignKeyName: "storage_costs_stock_movement_id_fkey"
      ...
      vehicles: {
        Row: {
          ...
          driver_id: string | null
          edit_price_by_admin_name: string | null
          features: Json | null
          fuel_type: string | null
          id: string
          image: string | null
          ...
          transmission: string | null
          type: string | null
          update_edit_price_date: string | null
          updated_at: string | null
    ...
    Functions: {
      ...
      auto_post_jurnal_from_mutasi: { Args: never; Returns: undefined }
      calc_intracity_price:
        | {
            Args: { p_city: string; p_distance_km: number; p_weight: number }
            Returns: {
        ...
        | { Args: { p_city: string; p_distance_km: number }; Returns: number }
      ...
      close_period: { Args: { p_period: string }; Returns: undefined }
      contoh_fungsi: { Args: never; Returns: undefined }
      ...
      enable_finish_on_enddate: { Args: never; Returns: undefined }
      find_uuid_in_tables: {
      ...
      get_driver_kpis: { Args: never; Returns: Json }
      get_drivers_not_rebooked: {
        Args: never
        Returns: {
          driver_id: string
          driver_name: string
      ...
      mark_ongoing_bookings: { Args: never; Returns: undefined }
      mark_overdue_bookings: { Args: never; Returns: undefined }
      my_function: { Args: never; Returns: undefined }
      norm_lt: { Args: { src: string }; Returns: string }
      notify_fanout: {
        Args: {
          body: string
          booking_id: string
      ...
      notify_upcoming_late_bookings: { Args: never; Returns: undefined }
      ...
      test_user_insert: { Args: never; Returns: undefined }
      ...
      update_all_account_totals: { Args: never; Returns: boolean }
      update_coa_balance: { Args: never; Returns: undefined }
      upsert_ledger_summaries:
        | {
            Args: { payload: Json }
            Returns: {
              error: true
            } & "Could not choose the best candidate function between: public.upsert_ledger_summaries(payload => text), public.upsert_ledger_summaries(payload => jsonb). Try renaming the parameters or the function itself in the database so function overloading can be resolved"
          }
        | {
            Args: { payload: string }
            Returns: {
      ...
      upsert_trial_balances:
        ...
        | {
            Args: { account_id: string; amount: number; period: string }
            Returns: undefined
          }
      verify_topup: {
